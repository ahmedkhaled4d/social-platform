...
articlesRouter.get(
  "/:slug/highlights/:highlightId/share/twitter",
  verifyToken,
  slugExist,
  highlights,
  shareHighlight,
...
articlesRouter.get(
  "/:slug/highlights/:highlightId/share/facebook",
  verifyToken,
  slugExist,
  highlights,
  shareHighlight,
...
articlesRouter.get(
  "/:slug/highlights/:highlightId/share/email",
  verifyToken,
  slugExist,
  highlights,
  shareHighlight,
...
articlesRouter.post(
  "/:slug/highlight",
  verifyToken,
  validateBody("validateHighlight"),
  slugExist,
  highlightExist,
  textExist,
  createHighlights

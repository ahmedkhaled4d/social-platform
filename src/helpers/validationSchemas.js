...
export default {
  ...
  login: Joi.object().keys({
    email: Joi.string()
      ...
      .min(3)
      .label(
        "Username or email are required, they must have at least 3 letters"
      ),
    password,
  }),
  ...
  updateUser: Joi.object().keys({
    firstName: Joi.string()
      ...
      .min(3)
      .label(
        "First name should have at least 3 letters and must contain only letters, underscores(_) and hyphens (-)"
      ),
    lastName: Joi.string()
      .trim()
      .regex(/^[A-Za-z_.-]+$/)
      .min(3)
      .label(
        "Last name should have at least 3 letters and must contain only letters, underscores(_) and hyphens (-)"
      ),
    username: Joi.string()
      .trim()
      .lowercase()
      ...
      .min(3)
      .label(
        "Username should have at least 3 letters and must contain only letters, numbers, underscores(_), hyphens (-) and points (.)"
      ),
    email: Joi.string()
      .trim()
      .lowercase()
  ...
  validateTerms: Joi.object().keys({
    termsAndConditions: Joi.string()
      ...
      .required()
      .label(
        "Terms and Conditions are required are required and should at least have 10 letters"
      ),
  }),
};
